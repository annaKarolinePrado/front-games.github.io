...
export class TrafficSignsComponent implements OnInit {
  ...
  private readonly easyCards = [
    ...
    { id: 15, emoji: '✈️', revealed: false },
    { id: 16, emoji: '✈️', revealed: false }
  ];
  ...
  private readonly hardCards = [
    ...
    { id: 22, emoji: '🅿️', revealed: false },  
    { id: 23, emoji: '🚻', revealed: false }, 
    { id: 24, emoji: '🅿️', revealed: false },  
    { id: 25, emoji: '✈️', revealed: false }, 
    { id: 26, emoji: '🚓', revealed: false }, 
    { id: 27, emoji: '✈️', revealed: false }, 
